...
export const AchievementsSection = () => {
  return <section id="achievements" className="py-24 bg-card">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          duration: 0.8
            ...
            <div className="space-y-4">
              {highlights.map((race, index) => <motion.div key={index} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
          ...
          duration: 0.8
            ...
            <div className="space-y-4">
              {upcomingRaces.map((race, index) => <motion.div key={index} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
            ...
            <div className="mt-6 p-6 bg-background/50 rounded-lg border border-border text-center">
              ...
              <div className="flex flex-col items-center justify-center gap-4 mt-4">
                <img src={mvmLogo} alt="Maharishi Vidya Mandir Logo" className="h-20 w-auto object-contain rounded-lg" />
                <p className="font-heading font-semibold text-foreground text-lg">MAHARISHI VIDYA MANDIR GROUP OF SCHOOLS</p>
              </div>
            </div>
          </motion.div>
        </div>
