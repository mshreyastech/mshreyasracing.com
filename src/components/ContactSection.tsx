          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <a 
                ...
                className="flex items-center gap-4 p-5 bg-card rounded-lg border border-border hover:border-primary/50 transition-all group"
              >
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-heading font-semibold text-foreground">+91 8754427475</p>
                </div>
              </a>
            ...
            >
              ...
              <Button 
                asChild 
                size="lg" 
                className="bg-gradient-racing hover:opacity-90 font-heading uppercase tracking-wider group w-full"
              >
              ...
              <div className="mt-6 pt-6 border-t border-border">
                <p className="text-muted-foreground text-sm text-center font-body">
                  Born: 26 August 2009 • Age: 16 years
                </p>
              </div>
            </motion.div>
          </div>
